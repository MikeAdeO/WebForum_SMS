...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 29, 2020 at 09:58 AM
...
(3, '2020_06_28_105722_create_students_table', 1),
(4, '2020_06_29_033100_create_staff_table', 1),
(5, '2020_06_29_033218_create_parents_table', 1),
(6, '2020_06_29_033244_create_admins_table', 1);
...
CREATE TABLE `parents` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `full name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `child_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `child_reg_number` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `staff` (
  ...
  `subject_taken` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `mobile_number` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
ALTER TABLE `staff`
  ...
  ADD UNIQUE KEY `staff_identity_num_unique` (`identity_num`);
